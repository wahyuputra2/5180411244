...
mulai :
    struct data pas[100];
    int pil, pil_1, pil_2, pil_3, a, b, c, d, e , f, g, h, j, k, i, l, m;
    ...
    case 3:
        ...
        cout<<"\n4. ubah data transaksi ";
        cout<<"\n0. kembali \n";
        cout<<"-----------------------------\n";
        cout<<"pilih : ";cin>>pil_3;
        switch(pil_3) {
        case 1:
            tran:
            system("cls");
            cout<<"masukksan jumlah data yang diinput : ";cin>>m;
            for (int t=0; t<m; t++){
                cout<<"masukkan tanggal pendaftaran[dd-mm-yyyy] : ";cin>>pas[t].tgl;
                break;
                goto tran;
                getch();
